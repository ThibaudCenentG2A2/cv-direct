                    ...
                    <div class="col-xs-3 col-sm-6 col-md-9">
                        ...
                        <div class="header-top-first clearfix">
                            <ul class="social-links circle small clearfix hidden-xs">
                                ...
                                <li class="facebook"><a target="_blank" href="https://www.facebook.com/CV-Direct-1263583010366791/"><i class="fa fa-facebook"></i></a></li>
                            ...
                            <ul class="list-inline hidden-sm hidden-xs">
                                <li><i class="fa fa-map-marker pr-5 pl-10"></i> 413 Avenue Gaston Berger</li>
                                <li><i class="fa fa-phone pr-5 pl-10"></i> +33 (0) 0 00 00 00 00</li>
                                <li><i class="fa fa-envelope-o pr-5 pl-10"></i> contact@cv-direct.fr</li>
                            </ul>
                        </div>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown ">
                                                            ...
                                                            <ul class="dropdown-menu to-left">
                                                                ...
                                                                <li ><a href="#">Ajouter compétence</a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </li>
...
if($test== 2)
    echo '<div class="col-xs-11 col-lg-4 alert alert-success animated fadeInDown" data-notify="container" role="alert" data-notify-position="top-right" style="display: inline-block; margin: 0px auto; position: fixed; tr_05s ease-in-out 0s; z-index: 1031; top: 100px; right: 20px;"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Votre inscription va etre validé par l\'administrateur, vous serez notifié par mail...</div>';
