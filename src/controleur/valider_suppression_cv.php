<?php
    ...
    if($_POST['action'] == 'Supprimer')
    {
        ...
        $piece_Jointe_A_Supprimer = new Piece_Jointe(null, $id_CV_A_Supprimer, null, null, null);

        /**
         * Gestion de suppression grâce à la fonction unlink()
         */
        foreach ($piece_Jointe_A_Supprimer->afficher_pieces_jointes() as $piece_jointe)
        {
            //unlink("../cv/pieces_jointes/" . $piece_jointe->get_token() . "." . $piece_jointe->get_extension());
            echo $piece_jointe->get_token() . "." . $piece_jointe->get_extension();
        }
